...
public class DetailTransitoFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		webview.loadDataWithBaseURL("",
				TransitoFragment.currentElement.getDESCRIPTION()
		...
		titre.setText(TransitoFragment.currentElement.getTITLE());
		date.setText(TransitoFragment.currentElement.getPUBDATE());
