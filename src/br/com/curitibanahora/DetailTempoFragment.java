...
public class DetailTempoFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		webview.loadDataWithBaseURL("",
				TempoFragment.currentElement.getDESCRIPTION()
		...
		titre.setText(TempoFragment.currentElement.getTITLE());
		date.setText(TempoFragment.currentElement.getPUBDATE());
