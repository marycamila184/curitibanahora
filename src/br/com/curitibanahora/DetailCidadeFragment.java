...
public class DetailCidadeFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		webview.loadDataWithBaseURL("",
				CidadeFragment.currentElement.getDESCRIPTION()
		...
		titre.setText(CidadeFragment.currentElement.getTITLE());
		date.setText(CidadeFragment.currentElement.getPUBDATE());
