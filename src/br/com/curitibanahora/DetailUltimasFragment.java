...
public class DetailUltimasFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		webview.loadDataWithBaseURL("",
				UltimasFragment.currentElement.getDESCRIPTION()
		...
		titre.setText(UltimasFragment.currentElement.getTITLE());
		date.setText(UltimasFragment.currentElement.getPUBDATE());
